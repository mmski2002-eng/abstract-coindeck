...
const RARITY_LABELS = ["Small", "Medium", "Heavy", "Super Heavy"];
const FILLS         = ["#D9D3C2", "#7AC7E8", "#26C6A8", "#88FC00"];
...
.card{width:300px;height:390px;background:${fill};border:3px solid #000;box-shadow:6px 6px 0 #000;display:flex;flex-direction:column;position:relative;overflow:hidden}
...
.egg{width:145px;height:145px;object-fit:contain;position:relative;z-index:2;filter:drop-shadow(0 0 14px rgba(255,255,255,.9)) drop-shadow(0 0 28px rgba(255,255,255,.5))}
...
.ticker-badge{font-size:11px;font-weight:900;color:#000;letter-spacing:.12em;text-transform:uppercase;border:2px solid #000;border-radius:5px;padding:2px 9px;background:rgba(255,255,255,.45);box-shadow:2px 2px 0 #000}
