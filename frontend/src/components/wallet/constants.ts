...
export const CARD_TIER_STYLES = [
  { color: "#9CA3AF", border: "rgba(156,163,175,0.45)", glow: "rgba(156,163,175,0.35)", gradient: "linear-gradient(180deg,rgba(156,163,175,0.18),rgba(156,163,175,0.02))", label: "COMMON" },
  { color: "#60A5FA", border: "rgba(59,130,246,0.6)",   glow: "rgba(59,130,246,0.45)",  gradient: "linear-gradient(180deg,rgba(59,130,246,0.25),rgba(59,130,246,0.03))",   label: "RARE" },
  { color: "#C084FC", border: "rgba(168,85,247,0.65)",  glow: "rgba(168,85,247,0.55)",  gradient: "linear-gradient(180deg,rgba(168,85,247,0.28),rgba(168,85,247,0.03))",   label: "EPIC" },
  { color: "#FBBF24", border: "rgba(245,158,11,0.85)",  glow: "rgba(245,158,11,0.7)",   gradient: "linear-gradient(180deg,rgba(245,158,11,0.32),rgba(245,158,11,0.04))",   label: "LEGENDARY" },
];
